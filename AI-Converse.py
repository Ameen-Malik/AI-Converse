...
# Add the path to ffplay
ffmpeg_path = r"D:\Downloads\ffmpeg-7.0.1-essentials_build\bin"
...
class ConversationManager:
    ...
    async def handle_message(self, result):
    ...
    async def get_transcript(self):
        try:
            ...
            dg_connection.on(LiveTranscriptionEvents.Transcript, self.handle_message)
